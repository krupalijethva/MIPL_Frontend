var BootstrapDatepicker = {
    init: function() {
     ...
     $("#m_datepicker_2_validate").datepicker({
        todayHighlight: !0,
        autoclose: !0,
        orientation: "bottom left",
        templates: {
