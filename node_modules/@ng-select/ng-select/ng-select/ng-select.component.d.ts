...
export declare class NgSelectComponent implements OnDestroy, OnChanges, AfterViewInit, ControlValueAccessor {
    ...
    constructor(config: NgSelectConfig, classes: string, _cd: ChangeDetectorRef, _console: ConsoleService, _zone: NgZone, _window: WindowService, elementRef: ElementRef);
